                  ...
                  >
                    ...
                    <ModalContent>
                      ...
                      <ModalHeader>
                        ...
                        Edit credentials <br/>  <Text fontWeight="light" color="#33363d"  fontSize='md'>Credentials add credibility to your content</Text></ModalHeader>
...
<Menu>
  ...
  <Text mt="4px" ml="5px" fontSize='xs'> YOUR CREDENTIALS</Text>
        <hr />
      {selectedItem === "Employment" && <h1>Em</h1> }
      {selectedItem === "Education" && <h1>ed</h1>}
